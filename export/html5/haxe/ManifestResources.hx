...
@:keep @:bind #if display private #end class __ASSET__assets_images_devpathlogo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/images/devpathlogo.png") #if display private #end class __ASSET__assets_images_devpathlogo_png extends lime.graphics.Image {}
